<?php
class ControllerKassaGuestShipping extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/kassa/guest_shipping.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/kassa/guest_shipping.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/kassa/guest_shipping.tpl', $data));
		}
	}
